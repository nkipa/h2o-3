...
#'        one of: "gaussian", "binomial", "fractional_binomial", "quasibinomial", "ordinal", "multinomial", "poisson",
...
h2o.glm <- function(x,
                    ...
                    offset_column = NULL,
                    weights_column = NULL,
                    family = c("gaussian", "binomial", "fractional_binomial", "quasibinomial", "ordinal", "multinomial", "poisson", "gamma", "tweedie", "negativebinomial"),
