...
class H2OGeneralizedLinearEstimator(H2OEstimator):
    ...
    def family(self):
        ...
        One of: ``"gaussian"``, ``"binomial"``, ``"fractional_binomial"``, ``"quasibinomial"``, ``"ordinal"``,
    ...
    def family(self, family):
        assert_is_type(family, None, Enum("gaussian", "binomial", "fractional_binomial", "quasibinomial", "ordinal", "multinomial", "poisson", "gamma", "tweedie", "negativebinomial"))
